package cn.xnc.intellij.plugin.activityanchor.sample;

import android.os.Parcelable;
import android.support.v7.app.AppCompatActivity;
import android.os.Bundle;
import android.util.Log;
import cn.xnc.intellij.plugin.activityanchor.sample.bean.TestBean;
import cn.xnc.intellij.plugin.activityanchor.sample.bean.TestSeri;
